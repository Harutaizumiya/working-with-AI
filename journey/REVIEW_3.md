...
这部分我觉得技巧和实践的分享也可以多一些
介绍一下我自己的经验，介绍一下 `Justineo/swrv-next` 这个 repo，里面有一个 journey 目录，记录了我在这个项目里使用 AI 的全过程，从策划、设计、实现到 review，每一步都有详细的记录和反思。

## query -> intent

这个 visualize 得还不够好，把 d3 删了吧，我感觉你需要 three.js

---

现在感觉内容有点少了，再脑暴一下，我应该再补充哪些方面，可以让这个分享更加活跃有趣，或者说更有实用价值？
